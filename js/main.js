;(function () {
	...
	var servicesAnimate = function() {
		...
		if ( $('#learning-column').length > 0 ) {	
			$('#learning-column .to-animate').each(function( k ) {
	...
	var servicesWayPoint = function() {
		...
		if ( $('#learning-column').length > 0 ) {
			$('#learning-column').waypoint( function( direction ) {
	...
	var testimonialsAnimate = function() {
		...
		if ( $('#OSDemo').length > 0 ) {	
			$('#OSDemo .to-animate').each(function( k ) {
	...
	var testimonialsWayPoint = function() {
		...
		if ( $('#OSDemo').length > 0 ) {
			$('#OSDemo').waypoint( function( direction ) {
	...
	// recommending
	var recommendingAnimate = function() {

		if ( $('#recommend').length > 0 ) {	
			$('#recommend .to-animate').each(function( k ) {
	...
	var recommendingWayPoint = function() {

		if ( $('#recommend').length > 0 ) {
			$('#recommend').waypoint( function( direction ) {
										
					setTimeout(function(){
						$('.animate-recommending-1').addClass('animated fadeIn');
					}, 200);
					setTimeout(function(){
						$('.animate-recommending-2').addClass('animated fadeIn');
					}, 300);
					setTimeout(recommendingAnimate, 700);
	...
	var pressAnimate = function() {
		...
		if ( $('#community').length > 0 ) {	
			$('#community .to-animate').each(function( k ) {
